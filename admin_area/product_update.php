<?php
	...
	$update = "UPDATE products SET p_cat_id = '$product_category', cat_id = '$category', brand_id = '$product_brand', product_title = '$product_title', product_img1 = '$product_img1',product_img2 = '$product_img2', product_img3 = '$product_img3', product_price = '$product_price', discount_price = '$discount_price', promo_price = '$promo_price', product_qty = '$product_qty', product_keyword = '$product_keyword', product_status = '$product_status', product_specs = '$product_specs', product_desc = '$product_desc' WHERE product_id = '$product_id'";
