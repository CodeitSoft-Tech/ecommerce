					...
					<div class="row">
						...
						<div class="col-lg-8 col-md-12 col-12">
							...
							<div class="right-content">
								<ul class="list-main">
									<li><i class="ti-user"></i> <a href="../checkout.php">My account</a></li>
								...
								<div class="sinlge-bar shopping">
									...
									while($row_products = mysqli_fetch_array($run_products))
									{
										...
										echo "<li>
												...
												<a class='cart-img' href='cart.php'><img src='admin_area/product_images/$product_img1' alt='Product Images'></a>
										...
										<div class="navbar-collapse">	
											<div class="nav-inner">	
												...
												<li><a href="../index.php">Home</a></li>
													...
													<li><a href="../sell_request.php">Sell With Us</a></li>
