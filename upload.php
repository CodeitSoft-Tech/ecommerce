 ...
 <form id="form1" action="upload.php" method="post" enctype="multipart/form-data" style="border: 2px solid #F7941D; padding: 25px; margin-bottom: 50px; margin-top: 50px;">
	...
	if(isset($_POST['submit']))
	{
		...
		$insert_product = "INSERT INTO pending_approvals(p_cat_id, cat_id, seller_id, date, product_title, product_img1, product_img2, product_img3, product_price, discount_price, promo_price, product_qty, product_keywords, product_status, product_specs, product_desc, approval_status)VALUES('$product_category', '$category','$cus_id', NOW(),'$product_title','$product_img1', '$product_img2', '$product_img3', '$product_price','$discount_price','$promo_price','$product_qty', '$product_keyword','$product_status','$product_specs','$product_desc','$approval_status')";
